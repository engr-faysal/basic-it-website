...
export const contactEmail = 'basic.it2020@gmail.com'
export const phoneNumber = '01743742098'
...
export const footerServicesSummary =
  'Website development, e-commerce website solutions, educational platforms, software systems, digital business setup, digital marketing support, and SaaS product planning.'
...
export const aboutSection = {
  title: 'About Basic IT',
  description:
    'Basic IT is a technology and digital business solutions brand established in 2019 and publicly launched in January 2020. The brand helps businesses, educators, coaching centers, and service providers build websites, digital presence, software systems, and product-based platforms with practical planning and clear communication.',
}

export const ecosystemSection = {
  title: 'Basic IT Ecosystem',
  description:
    'Basic IT combines service work, education-sector understanding, previous training experience, and product development under one practical technology brand.',
}
...
export const ecosystemItems = [
  {
    title: 'Basic IT',
    description:
      'Technology services, websites, software systems, SaaS products, and practical digital business solutions for growing businesses and educators.',
  },
  {
    title: 'Basic Academic & Admission Care',
    description:
      'Connected education work that gives Basic IT practical understanding of students, teachers, guardians, admission support, and coaching-related workflows.',
  },
  {
    title: 'Training Experience',
    description:
      'Previous IT and computer training initiatives. Current training activities are limited and may continue through online education platforms such as faysalimran.com.',
  },
  {
    title: 'Digital Business Support',
    description:
      'Facebook page setup, Google location support, branding basics, cover design, website planning, content direction, and online visibility support.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Product work such as STS and FitXtracker, planned around real workflows in education, fitness, communication, and progress tracking.',
  },
]

export const journeySection = {
  title: 'Basic IT Journey',
  intro:
    'A short professional timeline of Basic IT as a service and product-focused technology brand.',
  milestones: [
    {
      period: '2019',
      text: 'Basic IT was established with a focus on technology and digital services.',
    },
    {
      period: 'January 2020',
      text: 'Basic IT launched publicly and started providing digital business support.',
    },
    {
      period: '2020–2023',
      text: 'Worked with Facebook page setup, digital marketing support, websites, online presence, and education-related services.',
    },
    {
      period: '2024–2025',
      text: 'Expanded focus toward software systems, education technology, SaaS planning, and product development.',
    },
    {
      period: '2026+',
      text: 'Continuing as a service and product-based technology brand with products like STS and FitXtracker in development.',
    },
  ],
}
...
export const servicesSection = {
  title: 'Services',
  description:
    'The main services Basic IT offers for websites, platforms, software workflows, and digital business setup.',
}
...
export const helpSection = {
  title: 'How Basic IT Can Help You',
  description:
    'Not every customer knows the technical name of the service they need. Basic IT helps you understand the right digital solution based on your business goal.',
}

export const helpCards = [
  'I need a business website',
  'I want to sell courses or educational services',
  'I need an e-commerce website',
  'I want to start my online business presence',
  'I need software for my workflow',
  'I have a SaaS/product idea but need planning',
]
...
export const workedWithItems = [
  'Business websites',
  'E-commerce planning',
  'Teacher/course platforms',
